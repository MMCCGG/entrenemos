...
public class EjercicioServiceImpl implements EjercicioService{
    ...
    public EjercicioDto crear(EjercicioDto dto){
        ...
        return new EjercicioDto(e.getId(), e.getNombre(), e.getDescripcion(), e.getTipo(), e.getVideoUrl());
    }
    ...
    public List<EjercicioDto> listar(){
        return ejercicioRepository.findAll()
                .stream()
                .map(e -> new EjercicioDto(e.getId(), e.getNombre(), e.getDescripcion(), e.getTipo(), e.getVideoUrl()))
